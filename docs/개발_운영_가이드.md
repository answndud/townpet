...
```bash
cd /Users/alex/project/townpet2/app && pnpm lint src/server/queries/post.queries.ts src/server/queries/post.queries.test.ts
```

```bash
cd /Users/alex/project/townpet2/app && pnpm typecheck
```

```bash
cd /Users/alex/project/townpet2/app && pnpm test -- src/server/queries/post.queries.test.ts
```

```bash
cd /Users/alex/project/townpet2/app && pnpm test -- -t "partial test name"
```
...
```bash
cd /Users/alex/project/townpet2/app && pnpm test:e2e -- -g "partial test name"
```
