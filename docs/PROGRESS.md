...
- 상태: `in_progress`
- 현재 초점: `post-detail-client.tsx`의 primary card/media/actions 경계 분리를 완료했고, 다음 작업은 market/care/detail info panel 경계 분리다.
...
1. `post-detail-client.tsx`의 market/care/detail info panel 경계를 추가로 분리한다.
