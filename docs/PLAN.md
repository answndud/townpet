...
- 목표:
  ...
  - 우선순위는 모바일 상세 UI 정리, 인기글 빈 상태 개선, 체감 로딩 확인 순서로 둔다.
- 작업 순서:
  1. 게시글 상세 모바일 운영자 정보 CTA 중복 여부 정리
  ...
  3. public feed/detail 체감 로딩 재측정과 필요 수정
...
- 다음 액션:
  - 1번 게시글 상세 모바일 운영자 정보 CTA 중복 여부 정리부터 구현한다.
- 검증:
  - 최소 `pnpm -C app lint`
