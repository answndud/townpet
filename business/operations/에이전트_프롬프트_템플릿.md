...
```text
[Task]
목표: 신규 운영 규칙을 PLAN/DONE과 business/operations에 동기화
비목표: 앱 동작 변경
범위: PLAN.md, DONE.md, business/operations/*.md
위험도: 낮음
...
4. `@safety-verifier` 검증 결과를 `@plan-coordinator`가 `DONE.md`에 기록하고 `PLAN.md` 상태를 갱신
