...
- monitoringHeuristics: logger=1, monitorUnhandledError=52, provider-managed=1, static-response=1
...
| `/api/posts/[id]/lost-found-share.svg` | GET | public | manual | monitorUnhandledError | `src/app/api/posts/[id]/lost-found-share.svg/route.ts` | yes |
