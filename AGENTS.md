...
2. `docs/제품_기술_개요.md`에서 `LOCAL / GLOBAL`, 정책 우선 원칙, 구현 경계를 확인합니다.
...
- 제품 기준 충돌이 나면 `docs/제품_기술_개요.md`, `docs/policies/*`, `docs/security/*`를 우선합니다.
...
- 제품/정책 기준:
  - `docs/제품_기술_개요.md`, `docs/policies/*`, `docs/security/*`
- 작업 계획:
  - `PLAN.md`, `PROGRESS.md`
- 설명/홍보/해설:
  - `README.md`, `blog/*`
