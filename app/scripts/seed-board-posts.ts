...
const seedPosts: SeedPost[] = [
  ...
  },
  {
    ...
    title: "잠원동 야간 응급병원 다녀오신 분 후기 궁금해요",
    content: "고양이가 갑자기 토를 해서 혹시 야간 응급 대응 괜찮았던 병원 있으시면 경험 공유 부탁드립니다.",
    type: PostType.FREE_BOARD,
    scope: PostScope.LOCAL,
    communitySlug: "cats",
    neighborhoodIdKey: neighborhoodKey("서울", "서초구", "잠원동"),
    viewCount: 35,
    likeCount: 4,
  },
  {
  ...
  {
    authorEmail: "cat.parent@townpet.dev",
    title: "잠원동 회색 줄무늬 고양이 찾는 전단 보신 분 있나요",
