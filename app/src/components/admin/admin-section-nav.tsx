...
export const ADMIN_SECTION_LINKS = [
  ...
  { href: "/admin/ops", label: "Ops 대시보드", description: "헬스, 검색, 신고, 인증 상태 확인" },
  ...
  { href: "/admin/auth-audits", label: "인증 로그", description: "로그인/가입/비밀번호 변경 추적" },
  { href: "/admin/policies", label: "권한 정책", description: "신규 사용자/정책 운영값 조정" },
  { href: "/admin/personalization", label: "개인화 지표", description: "CTR과 audience 반응 확인" },
  {
  ...
  { href: "/admin/breeds", label: "품종 사전", description: "품종 catalog와 override 관리" },
] as const;
...
export function AdminSectionNav({ variant = "inline" }: AdminSectionNavProps) {
  if (variant === "grid") {
    return (
