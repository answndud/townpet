...
export const ACQUISITION_EVENT_LABELS: Record<AcquisitionEventValue, string> = {
  ...
  LOST_FLOW_VIEWED: "분실/목격 랜딩 조회",
  LOST_FLOW_CTA_CLICKED: "분실/목격 CTA 클릭",
  LOST_SHARE_PANEL_OPENED: "분실/목격 공유 도구 열기",
  LOST_SHARE_ACTION_CLICKED: "분실/목격 공유 액션 클릭",
  LOST_SIGHTING_MODE_SELECTED: "목격 제보 모드 선택",
  LOST_SIGHTING_SUBMIT_ATTEMPTED: "목격 제보 제출 시도",
