...
> 지역 + 상황별 반려생활 정보를 빠르게 찾고 공유하는 동네 반려생활 정보 커뮤니티

[데모 사이트 링크](https://townpet.vercel.app)
---
[개발 계획](./docs/PLAN.md) · [실행 로그](./docs/PROGRESS.md) · [완료 이력](./docs/COMPLETED.md)

## 개발자 구조

- 실행 코드와 명령의 소스 오브 트루스는 `app/`입니다.
- 저장소 진입점은 [`AGENTS.md`](/Users/alex/project/townpet/AGENTS.md)입니다.
- 제품/정책 기준은 [`business/제품_기술_개요.md`](/Users/alex/project/townpet/business/제품_기술_개요.md), `business/policies/*`, `business/security/*`를 우선합니다.
- `docs/PLAN.md`, `docs/PROGRESS.md`는 현재 맡은 작업만 남기는 active 상태 문서입니다.
- 완료된 작업 상세와 과거 검증 로그는 `docs/COMPLETED.md`에 보관합니다.

## 빠른 구조 파악

- 먼저 [`AGENTS.md`](/Users/alex/project/townpet/AGENTS.md), [`business/제품_기술_개요.md`](/Users/alex/project/townpet/business/제품_기술_개요.md), [`app/package.json`](/Users/alex/project/townpet/app/package.json)을 읽습니다.
...
<table>
  <tr>
    <td width="50%" valign="top">
      <img src="./business/assets/readme/feed-desktop.png" alt="TownPet 전체 피드" width="100%" />
      <p><strong>전체 피드</strong><br />게시판 태그, 정렬, 기간 필터가 한 화면에 보이는 커뮤니티 기본 화면</p>
    </td>
    <td width="50%" valign="top">
      <img src="./business/assets/readme/search-desktop.png" alt="TownPet 게시글 검색" width="100%" />
      <p><strong>게시글 검색</strong><br />검색 결과, 자동완성, zero-result 운영 개선이 연결되는 검색 화면</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="./business/assets/readme/adoption-desktop.png" alt="TownPet 유기동물 입양 게시판" width="100%" />
      <p><strong>유기동물 입양 게시판</strong><br />보호소, 지역, 품종 같은 구조화 정보를 카드 중심으로 보여주는 전용 게시판</p>
    </td>
    <td width="50%" valign="top">
      <img src="./business/assets/readme/market-desktop.png" alt="TownPet 중고 공동구매 게시판" width="100%" />
      <p><strong>중고 · 공동구매 게시판</strong><br />장터/공동구매 타입이 피드 필터와 함께 동작하는 거래형 게시판 화면</p>
    </td>
  </tr>
  <tr>
    <td width="50%" valign="top">
      <img src="./business/assets/readme/post-detail-desktop.png" alt="TownPet 글 상세와 댓글" width="100%" />
      <p><strong>글 상세와 댓글/반응</strong><br />글 본문, 구조화 메타 정보, 댓글, 반응까지 한 흐름으로 보여주는 상세 화면</p>
    </td>
    <td width="50%" valign="top" align="center">
      <img src="./business/assets/readme/adoption-mobile.png" alt="TownPet 모바일 입양 게시판" width="72%" />
...
- 작업을 작은 사이클로 분해하고, `docs/PLAN.md`/`docs/PROGRESS.md`에는 active 상태를, `docs/COMPLETED.md`에는 완료 이력을 남겼습니다.
...
- notification outbox retry, maintenance dry-run/apply guard, production health evidence까지 포함한 운영형 구조
- App Router API 48개에 대한 contract inventory와 validation/monitoring/test gap 점검
- 대형 post query/create 모듈을 list, personalization, detail widget, create variant 단위로 분리한 리팩터링
...
- 결과물 뒤에는 바로 확인 가능한 운영/문서 자산을 함께 남겼습니다.
  - 제품/운영 문서: [business](./business)
  - 계획/실행 로그: [PLAN.md](./docs/PLAN.md), [PROGRESS.md](./docs/PROGRESS.md), [COMPLETED.md](./docs/COMPLETED.md)
  - 보안 트랙: [보안 계획](./business/security/%EB%B3%B4%EC%95%88_%EA%B3%84%ED%9A%8D.md), [보안 진행상황](./business/security/%EB%B3%B4%EC%95%88_%EC%A7%84%ED%96%89%EC%83%81%ED%99%A9.md)
...
- 최신 검증 상태
  ...
  - API contract: 48 routes, missing method 0, adjacent test gap 1 (`/api/auth/[...nextauth]` provider-managed route)
...
- [API route inventory](./business/reports/api-route-inventory.md)
  - 48개 App Router API route의 method, 접근 수준, validation/monitoring 상태, 테스트 공백을 정리합니다.
- [API route contract report](./business/reports/api-route-contracts.generated.md)
  - route handler별 method/access/validation/monitoring/test adjacency를 생성 산출물로 고정합니다.
- [Production evidence latest](./business/reports/production-evidence-latest.md)
  - 배포 후 health smoke 결과를 최신 운영 증거로 유지합니다.
- 안전한 로컬 실행은 `app/.env.example`, 운영 env 기준은 `app/.env.production.example`을 봅니다.
...
- `posts/feed`
  ...
  - `app/src/server/queries/posts/post-feed-personalization.queries.ts`
  - `app/src/server/queries/posts/post-detail-widget.queries.ts`
  - `app/src/server/queries/posts/post.queries.ts` public facade
  - `app/src/app/feed`
...
- `moderation/ops`
  ...
  - `app/src/app/admin`
- `ops/evidence`
  - `app/scripts/check-api-route-contracts.ts`
  - `app/scripts/run-ops-evidence.ts`
  - `app/scripts/maintenance-run-mode.ts`
  - `app/scripts/retry-notification-deliveries.ts`
  - `business/reports/api-route-contracts.generated.md`
