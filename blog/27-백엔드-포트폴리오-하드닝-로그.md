...
TownPet의 App Router API route는 55개입니다.
...
NextAuth provider-managed catch-all route는 adjacent unit test gap 집계에서 제외하고, auth integration/e2e로 보는 기준으로 정리했습니다.
...
2. App Router route 55개를 contract report로 고정했고, validation/monitoring/test gap을 숫자로 관리했다.
