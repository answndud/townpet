...
TownPet는 README에서 “AI agent 기반으로 설계, 구현, 검증, 운영까지 밀어붙인 프로젝트”라고 설명합니다.
...
이 글의 목표는 TownPet에서 AI agent가 어떤 역할을 했는지, 그리고 무엇은 사람 판단으로 남겼는지를 구체적으로 설명하는 것입니다.
...
**프롬프트 자체도 운영 문서처럼 다뤘다**고 보는 편이 맞습니다.
...
이 글은 단일 test 파일보다 아래 묶음을 같이 보는 편이 좋습니다.
...
- 그래서 이 프로젝트는 AI 보조 코딩 예제가 아니라, AI를 개발 운영 체계 안에 넣은 예제로 보는 편이 맞습니다.
