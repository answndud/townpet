...
- `Account`
  - 소셜 provider 연결 상태를 저장합니다.
- `sessionVersion`
  - 현재 로그인 수단을 끊었을 때 세션을 함께 폐기하는 축입니다.
- `OAuthAccountNotLinked`
  - 안전하게 자동 병합하지 않는다는 신호입니다.

## 먼저 볼 핵심 파일

- [`app/src/lib/auth.ts`](../app/src/lib/auth.ts)
- [`app/src/server/services/auth.service.ts`](../app/src/server/services/auth.service.ts)
- [`app/src/app/api/auth/social-accounts/[provider]/route.ts`](../app/src/app/api/auth/social-accounts/[provider]/route.ts)
- [`app/src/app/api/auth/social-dev/link/route.ts`](../app/src/app/api/auth/social-dev/link/route.ts)
- [`app/src/lib/oauth-link-intent.ts`](../app/src/lib/oauth-link-intent.ts)
- [`app/src/lib/social-auth.ts`](../app/src/lib/social-auth.ts)
- [`app/src/lib/validations/auth.ts`](../app/src/lib/validations/auth.ts)
...
자동 로그인은 [`app/src/lib/auth.ts`](../app/src/lib/auth.ts)의 provider/adapter/callback이 담당하고, 명시 연결/해제는 [`auth.service.ts`](../app/src/server/services/auth.service.ts)에서 따로 다룹니다.

## 2. NextAuth callback은 무엇을 막는가

핵심은 [`callbacks.signIn`](../app/src/lib/auth.ts)입니다.
...
- [`linkSocialAccountForUser`](../app/src/server/services/auth.service.ts)
...
- [`POST /api/auth/social-dev/link`](../app/src/app/api/auth/social-dev/link/route.ts)
...
- [`unlinkSocialAccountForUser`](../app/src/server/services/auth.service.ts)

핵심 API:

- [`DELETE /api/auth/social-accounts/[provider]`](../app/src/app/api/auth/social-accounts/[provider]/route.ts)
...
- [`app/src/app/api/auth/social-accounts/[provider]/route.test.ts`](../app/src/app/api/auth/social-accounts/[provider]/route.test.ts)
