...
이 글의 목표는 성능 개선을 "튜닝 팁"으로 보지 않고, **데이터 구조와 계층 분리가 성능을 어떻게 바꾸는지** 설명하는 것입니다.
...
- [`app/src/server/cache/query-cache.ts`](/Users/alex/project/townpet/app/src/server/cache/query-cache.ts)
...
- [`app/src/server/queries/comment.queries.ts`](/Users/alex/project/townpet/app/src/server/queries/comment.queries.ts)
- [`app/src/server/queries/comment.queries.test.ts`](/Users/alex/project/townpet/app/src/server/queries/comment.queries.test.ts)
...
- [`app/src/lib/feed-list-presenter.ts`](/Users/alex/project/townpet/app/src/lib/feed-list-presenter.ts)
...
- [`query-cache.ts`](/Users/alex/project/townpet/app/src/server/cache/query-cache.ts)
...
- [`feed-infinite-list.tsx`](/Users/alex/project/townpet/app/src/components/posts/feed-infinite-list.tsx)
- [`feed-list-presenter.ts`](/Users/alex/project/townpet/app/src/lib/feed-list-presenter.ts)
...
- [`comment.queries.ts`](/Users/alex/project/townpet/app/src/server/queries/comment.queries.ts)
...
- [`ops-latency-snapshots.yml`](/Users/alex/project/townpet/.github/workflows/ops-latency-snapshots.yml)
...
- [`query-cache.test.ts`](/Users/alex/project/townpet/app/src/server/cache/query-cache.test.ts)
- [`comment.queries.test.ts`](/Users/alex/project/townpet/app/src/server/queries/comment.queries.test.ts)
